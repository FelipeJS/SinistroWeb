    ...
    <script type="text/javascript">
        ...
        function Pesquisar() {
            ...
            $.ajax({
                ...
                document.getElementById('DtRegistro').value.replace(/\//g, ''),
                data: "{}",
                dataType: 'json',
                success: function (result) {
                    //add data
            ...
            <ul class="menu" id="modulosMenu" runat="server">
                <li><a href="#" class="parent"><span>Consultas</span></a>
                    <div><ul class="">
                            ...
                            <li><a href="http://1.0.0.225:84/sinistro/processados"><span>Sinistros Processados - Coris/PET</span></a></li>
                         </ul>
                    </div>
                </li>
...
<option value="1297">.</option>
        ...
        <div class="cell"> 
            <label for="DataInicial">Data do Registro</label>           
            <input class="w75" id="DtRegistro" name="DtRegistro" type="text" value="" /> 
        </div>
