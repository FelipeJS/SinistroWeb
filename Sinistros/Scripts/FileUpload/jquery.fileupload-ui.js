...
(function (factory) {
    ...
    $.widget('blueimpUI.fileupload', parentWidget, {
        ...
        enable: function () {
            ...
            this._enableFileInputButton();
            this.element.find('input, button').button();
            this.element.find('input, button').button('enable');
        },
        ...
        disable: function () {
            ...
            this.element.find('input, button').button();
            this.element.find('input, button').button('disable');
        }
