...
(function ($) {
    $.fn.smartWizard = function (action) {
        ...
        return this.each(function () {
            ...
            var contentWidth = 0;
            var loader, msgBox, elmActionBar, elmStepContainer, btNext, btPrevious, btFinish, btBack;
            ...
            function init() {
                ...
                btBack = $('<a>' + options.labelBack + '</a>').attr("href", "#").addClass("buttonBack");

                btBack.attr("destiny", options.returnPage);

                if (options.showReturnButton) {
                    $(btBack).show();
                }
                else {
                    $(btBack).hide();
                ...
                elmActionBar.append(btFinish).append(btNext).append(btPrevious).append(btBack);
                ...
                if (options.keyNavigation) {
                    $(document).keyup(function (e) {
                        if (e.which == 39 && !e.ctrlKey && !e.shiftKey && e.currentTarget.activeElement.childElementCount > 0) { // Right Arrow
                            doForwardProgress();
                        } else if (e.which == 37 && !e.ctrlKey && !e.shiftKey && e.currentTarget.activeElement.childElementCount > 0) { // Left Arrow
                            doBackwardProgress();
                        }
                    });
                }
            ...
            function doChangePage() {
                if (!options.returnPage) {
                    ...
                    $(location).attr('href', options.returnPage);
                }
            }
    ...
    $.fn.smartWizard.goToStep = function () {
