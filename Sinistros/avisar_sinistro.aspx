...
/*            height: 23px;
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $("#TextBoxValor").blur(function () {
                var valor = $("#TextBoxValor").val().replace(",", ".");
...
<div id="wizard" class="swMain" >
    ...
    <!--PROTOTIPO INICIO-->
    <style>
        #t1,#t2,#t3 {background-color:White; border-bottom: 1px solid gray; width:75%; border-left:1px solid gray; margin-left:50px;}
        #t1:hover,#t2:hover,#t3:hover { background-color: #CCCCFF;}
    </style>
     <asp:Panel ID="Panel4" runat="server" >
     <table id="t1">
        <tr>
            <td>
             <span style="font-weight:600;">SEGURO:</span>  174056126 -  seg especial fin I (bilhete)   (Ramo: 9 PESSOAS COLETIVO)
             <input type="checkbox" name="news2" value="1"/>
            </td>
        </tr>
        ...
        <tr><td><span style="font-weight:600;">OBJETO SEGURADO :</span>    JOSE MENDES DE MOTA</td></tr>
        ...
        <tr><td>773574 – INVALIDEZ PERMANENTE TOTAL ACIDENT </td> <td style="text-align:left">3.000,00<input type="checkbox" name="news2" value="1"/></td></tr>
        <tr><td>773574 - MORTE</td>  <td style="text-align:left">3.000,00<input type="checkbox" name="news2" value="1"/></td></tr>
        <tr><td>773574 - DESEMPREGO INVOLUNTARIO</td> <td style="margin-left:1px;"> 600,00<input type="checkbox" name="news2" value="1"/></td></tr>
    </table>  
    <table  id="t2">
        <tr>
            <td>
        ...
        <tr><td>773574 – INVALIDEZ PERMANENTE TOTAL ACIDENT </td> <td style="text-align:left">3.000,00<input type="checkbox" name="news2" value="1"/></td></tr>
        <tr><td>773574 - MORTE</td>  <td style="text-align:left">3.000,00<input type="checkbox" name="news2" value="1"/></td></tr>
        <tr><td>773574 - DESEMPREGO INVOLUNTARIO</td> <td style="text-align:left"> 600,00<input type="checkbox" name="news2" value="1"/></td></tr>
    </table>
    <table  id="t3">
        <tr><td><span style="font-weight:600;">SEGURO:</span>  174056126 -  seg especial fin I (bilhete)   (Ramo: 9 PESSOAS COLETIVO)</td></tr>
        <tr><td><span style="font-weight:600;">SEGURADO</span>  JOSE MENDES MOTA</td><td style="color:Red;font-weight:800;">Sinistro  07770012342015</td></tr>
        <tr><td><span style="font-weight:600;">VIGENCIA</span>  01/07/2015 a 31/12/2015</td><td style="color:Red;font-weight:800;">Data abertura sinistro   10/10/2015</td></tr>
        <tr><td><span style="font-weight:600;">OBJETO SEGURADO :</span>    JOSE MENDES DE MOTA</td></tr>
        <tr><td><span style="font-weight:600;">COBERTURAS</span></td> 
        <td style="text-align:left"> <span style="font-weight:600;">INDENIZACAO</span></td></tr>
        <tr><td>773574 – INVALIDEZ PERMANENTE TOTAL ACIDENT </td> <td style="text-align:left">600,00</td></tr>
    </table> 
</asp:Panel>
<!--PROTOTIPO FIM-->
