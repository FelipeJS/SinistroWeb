...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function avisaSinistroAberto() {
            $(".marcar3").each(function () {
                if ($(this).prop("checked")) {
                    var link = "07770012342015";
                    var texto = "Atenção, já existe um sinistro aberto " + link + " deseja ir até ele?";
                    confirm(texto);
                }
            });
        }
        ...
        function avisaMorte() {
            $(".morte").each(function () {
                if ($(this).prop("checked"))
                    alert("Pergunte ao segurado se ele deseja abrir um sinistro de funeral!");
                });
        }

        function avisaPrestamista() {
            $(".prestamista").each(function () {
                if ($(this).prop("checked"))
                    alert("Pergunte ao segurado se ele deseja abrir um sinistro de prestamista!");
            });
        }
        ...
        $(document).ready(function () {
            ...
            // Protótipo
            if ($('#pnSeguro').is(':visible')) {
                $('#pnCoberturas').show();
                $('pnSeguro').hide();
                $('btnSeguroSeleciona').show();
            } else { $('#pnCoberturas').hide(); }


            $("#btnSalvar").click(function () {
                alert("apertou");
                var valor = $("#TextBoxValor").replace(",", ".").valueOf;
                if (valor < 0.01) {
...
<div id="wizard" class="swMain" >
    ...
    <table style="width:100%;">
        ...
        <tr>
            <td class="style4">
                <asp:DropDownList ID="ddTpSinistro" runat="server" Enabled="true" >
    ...
    <style>
     ...
     <asp:Panel ID="pnCoberturas" runat="server" >
     <table id="t1">
        <tr>
            <td >
             <span style="font-weight:600;">SEGURO:</span>  174056126 -  seg especial fin I (bilhete)   (Ramo: 09 PESSOAS COLETIVO)
            
            </td>
            <td > <input style="margin-left:43px;" type="checkbox" name="news2" value="1" class="marcar1"/> 
                <input style="margin-left:2px;" type="button" value="Marcar Todos" onclick="marcardesmarcar1()"/>
            </td>
        </tr>
        <tr><td ><span style="font-weight:600;">SEGURADO</span>  JOSE MENDES MOTA</td><td style="color:White;font-weight:800;">Sinistro  07770012342015</td></tr>
        <tr><td><span style="font-weight:600;">VIGENCIA</span>  01/07/2015 a 31/12/2015</td><td style="color:White;font-weight:800;">Data abertura sinistro   10/10/2015</td></tr>
        <tr><td ><span style="font-weight:600;">OBJETO SEGURADO :</span>    JOSE MENDES DE MOTA</td><td > </td></tr>
        <tr><td><span style="font-weight:600;">COBERTURAS</span></td> 
        <td style="text-align:left;"> <span style="font-weight:600;">IS MÁXIMA</span></td></tr>
        <tr><td>773574 – INVALIDEZ PERMANENTE TOTAL ACIDENT </td> <td style="text-align:left">3.000,00<input type="checkbox" name="news2" value="1" class="marcar1"/></td></tr>
        <tr><td>773574 - MORTE</td>  <td style="text-align:left">3.000,00<input type="checkbox" value="1" class="marcar1 morte" onclick="avisaMorte()"/></td></tr>
        <tr><td>773574 - DESEMPREGO INVOLUNTARIO</td> <td style="margin-left:1px;"> 600,00  <input style="margin-left:10px;" type="checkbox"  value="1" class="marcar1 prestamista" onclick="avisaPrestamista()"/></td></tr>
    </table>  
    <table  id="t2">
        <tr>
            <td >
             <span style="font-weight:600;">SEGURO:</span>  174056126 -  seg especial fin I (bilhete)   (Ramo: 09 PESSOAS COLETIVO)
            </td><td > <input style="margin-left:43px;" type="checkbox" name="news2" value="1" class="marcar2"/>
                <input style="margin-left:2px;" type="button" value="Marcar Todos" onclick="marcardesmarcar2()"/>
                 </td>        
        </tr>
        <tr><td ><span style="font-weight:600;">SEGURADO</span>  JOSE MENDES MOTA</td><td style="color:White;font-weight:800;">Sinistro  07770012342015</td></tr>
        <tr><td><span style="font-weight:600;">VIGENCIA</span>  01/07/2015 a 31/12/2015</td><td style="color:White;font-weight:800;">Data abertura sinistro   10/10/2015</td></tr>
        ...
        <tr><td><span style="font-weight:600;">COBERTURAS</span></td> 
        <td style="text-align:left"> <span style="font-weight:600;">IS MÁXIMA</span></td></tr>
        <tr><td>773574 – INVALIDEZ PERMANENTE TOTAL ACIDENT </td> <td style="text-align:left">3.000,00<input type="checkbox" name="news2" value="1" class="marcar2"/></td></tr>
        <tr><td>773574 - MORTE</td>  <td style="text-align:left">3.000,00<input type="checkbox" value="1" class="marcar2 morte" onclick="avisaMorte()"/></td></tr>
        <tr><td>773574 - DESEMPREGO INVOLUNTARIO</td> <td style="text-align:left"> 600,00<input style="margin-left:12px;" type="checkbox" value="1" class="marcar2 prestamista" onclick="avisaPrestamista()"/></td></tr>
    </table>
    <table  id="t3">
        <tr><td ><span style="font-weight:600;">SEGURO:</span>  174056126 -  seg especial fin I (bilhete)   (Ramo: 09 PESSOAS COLETIVO)</td>
            <td > <input style="margin-left:231px;" type="checkbox" name="news2" value="1" class="marcar3"/> 
                <input style="margin-left:2px;" type="button" value="Marcar Todos" onclick="marcardesmarcar3()"/>
            </td>
        </tr>
        <tr><td ><span style="font-weight:600;">SEGURADO</span>  JOSE MENDES MOTA</td><td style="color:Red;font-weight:800;">Atenção, já existe um sinistro aberto <a href="#">(07770012342015)</a> em 10/10/2015</td></tr>
        <tr><td><span style="font-weight:600;">VIGENCIA</span>  01/07/2015 a 31/12/2015</td><td style="color:Red;font-weight:800;">realmente deseja abrir um novo sinistro, ou deseja realmente abrir um novo sinistro, ou quer atendimento para o mesmo?</td></tr>
        <tr><td><span style="font-weight:600;">OBJETO SEGURADO :</span>    JOSE MENDES DE MOTA</td><td > </td></tr>
        <tr><td><span style="font-weight:600;">COBERTURAS</span></td> 
        <td style="text-align:left"> <span style="font-weight:600;">INDENIZACAO</span></td></tr>
        <tr><td>773574 – INVALIDEZ PERMANENTE TOTAL ACIDENT </td> <td style="text-align:left">600,00<input style="margin-left:201px;" type="checkbox" name="news2" value="1" class="marcar3" onclick="avisaSinistroAberto()"/></td></tr>
    </table> 

<asp:Button ID="btnSelecionarSeguro" runat="server" onclick="btnSelecionarSeguro_Click" 
                    Text="Selecionar" />
</asp:Panel>
<!--PROTOTIPO FIM-->
...
">
        ...
        <tr>
            ...
            <td class="style2">
                <asp:TextBox ID="TextBoxValor" runat="server" Text="300"  ></asp:TextBox>
                &nbsp; Data Aviso :<asp:TextBox ID="TextBoxDtAviso" runat="server" ></asp:TextBox>
                <asp:Button ID="btnSalvar" runat="server" Text="Salvar" onclick="btnSalvar_Click" class="salvar"/>
...
ID_SINISTRO, ID_USUARIO)
VALUES 
(replace(:vlReserva,',','.'), 'A', sysdate, 1, 0, 1, :tpSinistro, 
(select max(id_sinistro) from sma_sinistro where id_sinistro < 900000), :idUsuario)
 ">
        <InsertParameters>
