<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="corisclaimsimp.aspx.cs" Inherits="Sinistros.corisclaimsimp" %>

<html xmlns="http://www.w3.org/1999/xhtml">

<head id="Head2" runat="server">
    <title>Importar Aquivo Coris - Claims</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <br />
            ...
            <tr>
                <td>
                    <asp:Panel runat="server" ID="pnProcessar" Visible="false">
                                <asp:Label runat="server" ID="lbPagto" ForeColor="Red" Text="Pagamento Para D +" />
                                <asp:TextBox runat="server" ID="txtDiasPagto" Width="20px" Height="20px" Text="5"></asp:TextBox>
                                <asp:Button runat="server" ID="btProcessar" Text="Processar Arquivo" OnClick="btProcessar_Click" />
                    </asp:Panel>
                </td>
            </tr>
