...
function initMessageBox(bNeebBack) {
    ...
    objString += "<div style='text-align:left; width:" + _iWidth + "px; background-color:#FFFFFF;";
    if (_bShowNavigatorPanel)
        objString += "display:block'>";
    else
        objString += "display:none'>";
    objString += "<div style='position:relative; background:white; float:left; width:730px; height:35px; z-index:2;'>";
    objString += "<!--div style='position:relative; background:white; float:left; width:150px; height:35px;z-index:2;'-->Visualizar&nbsp;&nbsp;";
    ...
    objString += "<!--div style='position:relative;'--><input id='DW_btnRemoveCurrentImage' onclick='btnRemoveCurrentImage_onclick()' type='button' value='Remover Selecionados'/>";
    if (bNeebBack) {
        objString += "<input id='DW_btnRemoveAllImages' onclick='btnRemoveAllImages_onclick()' type='button' value='Remover Todos'/>&nbsp;&nbsp;<!--br /><br /-->";
        objString += "<!--span style=\"font-size:larger\"><a href =\"online_demo_list.aspx\"><b>Back</b></a></span><br /></div-->";
    }
    else
        objString += "&nbsp;&nbsp;<input id='DW_btnRemoveAllImages' onclick='btnRemoveAllImages_onclick()' type='button' value='Remover Todos'/><br /></div>";
    objString += "</div>";
...
function checkErrorString() {
    if (DWObject.ErrorCode == 0) {
        appendMessage("<span style='color:#cE5E04'><b>Adicionado com sucesso.</b></span><br />");
