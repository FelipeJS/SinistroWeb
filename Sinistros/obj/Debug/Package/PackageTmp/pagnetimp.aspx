<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pagnetimp.aspx.cs" Inherits="Sinistros.pagnetimp" %>

<html xmlns="http://www.w3.org/1999/xhtml">

<head id="Head2" runat="server">
    <title>Importar Aquivo Retorno do Pagnet</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="container_body">
         ...
         <div id="title">
            <h3>
            Importar Aquivo de Retorno do Pagnet
