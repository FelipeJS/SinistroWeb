...
function loadSampleImage(nIndex) {
    ...
    switch (nIndex) {
        case 1:
            ImgArr = "/Images/doc1.jpg";
            break;
        case 2:
            ImgArr = "/Images/doc2.jpg";
            break;
        case 3:
            ImgArr = "/Images/doc3.jpg";
            break;
    }
    ...
    updatePageInfo();
    if (checkErrorString()) {
        appendMessage("Imagem pré-carregada adicionada com sucesso.<br/>");
    }
}
...
function initInfo() {
    ...
    if (MessageBody) {
        var ObjString = "<div>";
        ObjString += "This sample demonstrates how to upload images to the server asynchronously.<br />";
        ObjString += "<br />";
        ObjString += "You can also upload extra info to be saved in the file 'extraInfo.txt' on the server. It allows you to process the text like saving it in database on the server.<br />";
        ObjString += "<br />";
        ObjString += "You can check the JavaScript behind this page to see how this is done!<br />";
        ObjString += "<br />";
