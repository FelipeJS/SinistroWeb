<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="petimp.aspx.cs" Inherits="Sinistros.petimp" %>

<html xmlns="http://www.w3.org/1999/xhtml">

<head id="Head2" runat="server">
    <title>Importar Aquivo Pagamentos Pet</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <br />
        <br />
               <asp:Label runat="server" ID="lbStatus" ForeColor=Red Text="Status: Selecione o arquivo" />
               <asp:Label runat="server" ID="lbPagto" ForeColor="Red" Text="Pagamento Para D +" Visible="false"/>
               <asp:TextBox runat="server" ID="txtDiasPagto" Width="20px" Height="20px" Text="5" Visible="false"></asp:TextBox>
               <asp:Button runat="server" ID="btProcessar" Text="Processar Arquivo" OnClick="btProcessar_Click" Visible="false" />
               <input type="button" id="btnDownload" value="Baixar Arquivo"/>
               <script type="text/javascript">
