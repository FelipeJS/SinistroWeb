...
<body>
    ...
    <!--div class="frame"-->
        ...
        <table>
            <tr>
                <td>
                    <div id="mesAtual" class="frameResultado" runat="server"><table id="flexMesAtual"> </table></div>
                </td>
                <td rowspan=2>
                    <div id="mesPorPrograma" class="frameResultado" runat="server"><table id="flexPorPrograma"> </table></div>
                </td>
            </tr>
            <tr>
                <td><div id="sinistrosGrid" class="frameResultado" runat="server"><table id="flexStatus"> </table></div> </td>
                <td></td>
            </tr>
        </table>
...
<script type="text/javascript">
    $(function () {
        $("#mes").monthpicker("2014-9",callback);
    });

    function callback(data, $e) {
        var str = "";
        str = data.month;
        if (data.month < 10) { str = "0" + data.month }
        str += data.year;
