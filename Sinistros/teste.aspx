<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="teste.aspx.cs" Inherits="Sinistros.teste" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#flex1").flexigrid({
                ...
                method: 'GET',
                colModel: [
                        { display: 'ID', name: 'ID_SINISTRO', width: 40, sortable: true, align: 'left' },
                        { display: 'First Name', name: 'NR_SINISTRO', width: 150, sortable: true, align: 'left' },
                        { display: 'Surname', name: 'DS_CLIENTE', width: 150, sortable: true, align: 'left' },
                        { display: 'Position', name: 'DS_CLIENTE', width: 250, sortable: true, align: 'left' }
                ],
                buttons: [
                        { name: 'Edit', bclass: 'edit', onpress: finalizarApolice },
                        { name: 'Delete', bclass: 'delete', onpress: finalizarApolice },
                        { separator: true }
                ],
                searchitems: [
                        { display: 'First Name', name: 'ID_SINISTRO' },
                        { display: 'Surname', name: 'NR_SINISTRO', isdefault: true },
                        { display: 'Position', name: 'DS_CLIENTE' }
                ],
                sortname: "ID_SINISTRO",
                sortorder: "asc",
                usepager: true,
                title: "Staff",
                useRp: true,
...
<div id="wizard" class="swMain" >
    ...
    <div id="step-1">	    
        ...
        <tr>
            <td class="style4">
                <asp:DropDownList ID="ddTpSinistro" runat="server">
            ...
            <td>
                <asp:Button ID="Iniciar" runat="server" onclick="Button1_Click" 
                    Text="Iniciar" />
            </td>
        </tr>
        <tr>
...
&nbsp;&nbsp; Tipo Reclamante</td>
            <td>
                ...
                <asp:SqlDataSource ID="parentesco" runat="server" 
                    ...
                    ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="select * from SYS_TPPARENTESCO
        ...
        <tr>
            ...
            <td class="style2">
                ...
                <asp:SqlDataSource ID="cobertura" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                    ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="select * from TB_CAD_COBSU"></asp:SqlDataSource>
            </td>
            <td class="style3">
                &nbsp;</td>
            <td>
...
"
        SelectCommand="SELECT S.*, TO_CHAR(ID_SINISTRO) ID_SINISTRO_S FROM SMA_SINISTRO S WHERE ID_SEGURO = :idSeguro and dt_ocorrencia = :dtOcorrencia order by id_sinistro desc"
...
:tpSinistro, :dtOcorrencia, :dtAviso, :nmReclamante, :cpfReclamante, :idSeguro, :tpReclamante, :cdCober, :idCausa, :idEndosso, 213,
...
ID_SINISTRO)
VALUES 
(:vlReserva, 'A', sysdate, 1, 0, 1, :tpSinistro, 
...
VALUES
((select max(id_sinistro) from sma_sinistro where id_sinistro < 900000), 40, sysdate, 213)
">
    </asp:SqlDataSource>
    ...
    <div id="step-2">	    
        ...
        <asp:FormView ID="FormView1" runat="server" DataSourceID="SMA_SINISTRO">
            <ItemTemplate>
                ...
                <br />
                <asp:TextBox ID="TextBox2" runat="server" Text='<%# Eval("NR_SINISTRO") %>'  ReadOnly="true"></asp:TextBox>
            </ItemTemplate>
        </asp:FormView>
